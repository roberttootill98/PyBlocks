...
Blockly.Python['python_string_index'] = function(block) {
  ...
  return [block1 + '[' + block2 + ']', Blockly.Python.ORDER_NONE];
};
...
Blockly.Python['python_string_slice12'] = function(block) {
  ...
  return [block1 + '[' + block2 + ':' + block3 + ']', Blockly.Python.ORDER_NONE];
};
...
Blockly.Python['python_isdigit'] = function(block) {
  ...
  return [code + '.isdigit()', Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['python_isalpha'] = function(block) {
  var code = Blockly.Python.valueToCode(block, 'ARG', Blockly.Python.ORDER_MEMBER);
  return [code + '.isalpha()', Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['python_isspace'] = function(block) {
  var code = Blockly.Python.valueToCode(block, 'ARG', Blockly.Python.ORDER_MEMBER);
  return [code + '.isspace()', Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['python_lower'] = function(block) {
  var code = Blockly.Python.valueToCode(block, 'ARG', Blockly.Python.ORDER_MEMBER);
  return [code + '.islower()', Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['python_upper'] = function(block) {
  var code = Blockly.Python.valueToCode(block, 'ARG', Blockly.Python.ORDER_MEMBER);
  return [code + '.isupper()', Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['python_find'] = function(block) {
  var block1 = Blockly.Python.valueToCode(block, 'LHS', Blockly.Python.ORDER_MEMBER);
  var block2 = Blockly.Python.valueToCode(block, 'RHS', Blockly.Python.ORDER_NONE);
  return [block1 + '.find(' + block2 + ')', Blockly.Python.ORDER_FUNCTION_CALL];
};
...
Blockly.Python['python_string_count'] = function(block) {
  var block1 = Blockly.Python.valueToCode(block, 'LHS', Blockly.Python.ORDER_MEMBER);
  var block2 = Blockly.Python.valueToCode(block, 'RHS', Blockly.Python.ORDER_NONE);
  return [block1 + '.count(' + block2 + ')', Blockly.Python.ORDER_FUNCTION_CALL];
};
