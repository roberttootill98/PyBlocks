        ...
        if (this.outputsAList()) {
            ...
            if(Blockly.modalWindow.visible && Blockly.modalWindow.type == 'create') {
                ...
                for(i = 0; i < variableTypeInputs.length; i++) {
                    if(Blockly.modalWindow.builtInTypes.includes(variableTypeInputs[i].value)) {
                        break;
                    }
                }
            } else {
    ...
    if (this.outputConnection && this.outputsAList()) {
        ...
        for(var i = 1; i < this.listAmount; i++) {
            ...
            if(!svgList[i]) {
                ...
                svgList[i] = [whiteSvgPath, greySvgPath];
            }
            ...
            for (var x = 0, input; input = row[x]; x++) {
                ...
                if (input.type == Blockly.INPUT_VALUE) {
                    ...
                    if (!input.connection.targetConnection) {
                        ...
                        var indicatorY = cursorY + input.unextendedHeight -
